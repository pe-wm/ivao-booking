						...
						<div class="table-responsive">
							<table class="table">
								...
								<tr>
									<th>Event about</th>
									<td>
										<textarea class="form-control" id="txtEventAbout" maxlength="300" placeholder="About the event... (max 300 chars)" rows="4" required><?=$config["event_about"] ?? ""?></textarea>
									</td>
								</tr>
								<tr>
									<th>Event banner</th>
									<td>
										<input class="form-control" id="txtEventBanner" type="text" maxlength="300" placeholder="URL to the event banner image..." value="<?=$config["event_banner"] ?? ""?>">
									</td>
								</tr>
								<tr>
								...
								<tr>
									<th>Booking behavior</th>
									<td>
									<div class="custom-control custom-checkbox">
										<input type="checkbox" class="custom-control-input" id="chkPrebook"<?=(isset($config["prebook"]) && $config["prebook"] == "true" ? " checked" : "")?>>
										<label class="custom-control-label" for="chkPrebook">Firstly Prebook (staff must approve)</label>
									</div>
									<div class="text-muted"><small>When checked, flights will be pre-booked and require user confirmation (sent by email to the pilot).</small></div>
								</td>
							</tr>
								<tr>
									<th>
										...
										<div class="form-row">									
											<div class="col">
												<div class="input-group">
													...
													<input class="form-control" id="txtDivisionDiscord" type="text" placeholder="Discord link" value="<?=$config["division_discord"] ?? $config["division_facebook"]?>">																								
												</div>											
											</div>	
											<div class="col">
												<div class="input-group">
													...
													<input class="form-control" id="txtDivisionInstagram" type="text" placeholder="Instagram link" value="<?=$config["division_instagram"] ?? $config["division_twitter"]?>">																								
												</div>											
											</div>									
										</div>
						...
						<div class="card-body">
							<form id="frmAirportEdit">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<select id="txtAirportType">
											<option value="small_airport">small airport</option>
											<option value="medium_airport" selected>medium airport</option>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input class="form-control" type="text" id="txtAirportLatitude" required placeholder="e.g. -33.393001556396484">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label">Longitude:</label>
									<div class="col-sm-10">
										<input class="form-control" type="text" id="txtAirportLongitude" required placeholder="e.g. -70.78579711914062">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label">Altitude:</label>
									<div class="col-sm-10">
										<input class="form-control" type="text" id="txtAirportAltitude" required placeholder="in feet">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label">Country Code:</label>
									<div class="col-sm-10">
										<input class="form-control" type="text" id="txtAirportCountry" required placeholder="e.g. PE">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label">Iata code:</label>
									<div class="col-sm-10">
										<input class="form-control" type="text" id="txtAirportIata" required placeholder="e.g. JCL">
									</div>
								</div>
								<div class="form-group row">
...
?>
				...
				<div class="tab-pane fade" id="tabFlightMgmt" role="tabpanel">
					...
					<div class="card mb-4">
						<h5 class="card-header">Import flights</h5>
						<div class="card-body">
							<p class="card-text">Import flights from a JSON file.</p>
							<input type="file" id="fileImportFlights" class="form-control-file mb-3" accept=".json">
							<button class="btn btn-warning" onclick="adminImportFlights()">Import from JSON</button>
						</div>
					</div>
					
					<?php /*
					<div class="card mb-4 border-danger">
						<h5 class="card-header bg-danger text-white">Clear flights database</h5>
						<div class="card-body">
							<p class="card-text">This action will delete all flights from the database. It cannot be undone.</p>
							<button class="btn btn-danger" onclick="adminClearFlights()">Clear all flights</button>
						</div>
					</div>
					*/ ?>
				</div>
