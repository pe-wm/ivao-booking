		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="btn-group btn-group-sm mr-2" role="toolbar" id="slotAdminButtons">
					<button type="button" class="btn btn-success" id="btnSlotAdminAccept" style="display:none;">Accept</button>
					<button type="button" class="btn btn-warning" id="btnSlotAdminReject" style="display:none;">Reject</button>
