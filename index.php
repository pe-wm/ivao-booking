...
Menu::addItems([
	...
	[
		"text" => '<i class="fas fa-clock"></i> Slots',
		"href" => "slots"
	],
	[
		"text" => "Statistics",
...
<head>
	...
	<link rel="stylesheet" href="js/node_modules/@fortawesome/fontawesome-free/css/all.min.css">
...
<footer class="footer">		
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<p>&copy; 2026 <a href="<?=$config["division_web"]?>" target="_blank"><?=$config["division_name"]?></a></p>
				<!--<p><i class="far fa-envelope-open"></i> <a href="contact">Contact us!</a></p>-->
			</div>
			<div class="col-md-4 text-md-center">
<?php if (!empty($config["division_facebook"])): ?>
				<p><i class="fab fa-discord"></i> <a href="<?=$config["division_facebook"]?>" target="_blank">Find us on Discord</a></p>
<?php endif; ?>
<?php if (!empty($config["division_twitter"])): ?>
				<p><i class="fab fa-instagram"></i> <a href="<?=$config["division_twitter"]?>" target="_blank">Find us on Instagram</a></p>
<?php endif; ?>
			</div>
			<div class="col-md-4 text-md-right">
				<p>Developed by <a href="https://www.ivao.aero/Member.aspx?ID=540147" target="_blank">Donat Marko (540147)</a></p>
				<p>Improvements by <a href="https://www.ivao.aero/Member.aspx?ID=234242" target="_blank">Gorka Santisteban (234242)</a></p>
			</div>
		</div>
	</div>
</footer>
...
<script src="js/node_modules/moment/locale/en-gb.js"></script>
<script src="js/node_modules/popper.js/dist/umd/popper.min.js"></script>
...
<script src="js/node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
<script src="js/node_modules/ckeditor/ckeditor.js"></script>
